(() => {
  ...
  function renderGridLines() {
    ...
    for (let i = 0; i <= ROW_COUNT; i++) {
      lines.push(`<div class="row-line" style="top:${i}00%; transform:translateY(-0.5px);"></div>`.replace(`${i}00%`, `${(i / ROW_COUNT) * 100}%`));
    }
